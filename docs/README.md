...
| 3 | [defects.md](defects.md) | 재현 테스트가 붙은 결함 25건. **패턴 학습보다 함정 학습이 빠르다** |
...
| [defects.md](defects.md) | 결함 대장 25건 (살아 있는 것 1건 — [D-026](defects.md#d-026)). **추측은 넣지 않는다** — 전부 재현 테스트가 하나씩 붙어 있다 |
