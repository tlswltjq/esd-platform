...
/** download 모듈 패키지 구조 검증. 규칙 본체는 libs:common-archunit 에 한 벌만 둔다. */
@AnalyzeClasses(packages = "com.stove.download", importOptions = ImportOption.DoNotIncludeTests.class)
class DownloadArchitectureTest {
